...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO tblapplicants (FNAME, MNAME, LNAME, ADDRESS, SEX, BIRTHDATE, BIRTHPLACE, TELNO, CIVILSTATUS, EMAILADDRESS, USERNAME, PASS, DEGREE)
            VALUES ('$FNAME', '$MNAME', '$LNAME', '$ADDRESS', '$SEX', '$BIRTHDATE', '$BIRTHPLACE', '$TELNO', '$CIVILSTATUS', '$EMAILADDRESS', '$USERNAME', '$PASS', '$DEGREE')";
...
<?php if (!isset($_SESSION['APPLICANTID'])) { ?>
    <form action="" class="bg-white p-5 contact-form" enctype="multipart/form-data" method="POST">
        <div class="form-group">
            <input class="form-control" id="FNAME" name="FNAME" placeholder="First Name" type="text" value="" onkeyup="javascript:capitalize(this.id, this.value);" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input class="form-control" id="LNAME" name="LNAME" placeholder="Last Name" onkeyup="javascript:capitalize(this.id, this.value);" required>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-12">
        <div class="row">
            <form class="form-horizontal span6" 
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="col-md-10" style="padding: 0; margin: 0;">
                                    <!-- File input -->
                                    <input id="picture" name="picture" type="file" required accept=".pdf">
                                    <input name="MAX_FILE_SIZE" type="hidden" value="1000000">
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <button class="btn btn-primary btn-md pull-right" name="submit" type="submit">
