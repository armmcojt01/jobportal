...
<head>
<meta charset="utf-8">
<title>ORIS / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+63) 2 89481263</p>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <address>
          <strong>Pang-Alaalang Sentrong Medikal Amang Rodriguez</strong><br>
          Sumulong Highway Sto. Niño,<br>
          Marikina City, 1800</address>
          <p>
            <i class="icon-phone"></i> (+63) 89415854 <br>
            <i class="icon-envelope-alt"></i> hrmo@armmc.doh.gov.ph
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <ul class="link-list">
            <?php 
                  $sql = "SELECT * FROM `tbljob` j WHERE c.`JOBID`=j.`JOBID`   ORDER BY DATEPOSTED DESC LIMIT 3" ;
                  $mydb->setQuery($sql);
                  $cur = $mydb->loadResultList();


                  foreach ($cur as $result) {
                    echo ' <li><a href="'.web_root.'index.php?q=viewjob&search='.$result->JOBID.'">'.'/ '. $result->OCCUPATIONTITLE .'</a></li>';
                  } 
              ?> 
          </ul>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; IMISS 2024 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
