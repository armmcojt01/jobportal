...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>AORS</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>ARMMC ONLINE RECRUITMENT SYSTEM</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu"> 
        ...
        $sql = "SELECT count(*) as 'APPL' FROM `tbljobregistration` WHERE `PENDINGAPPLICATION` = 1";
          ...
          $pendingApplicants = $pending ? $pending->APPL : 0;
        ?>
        <li class="<?php echo (currentpage() == 'applicants') ? "active" : ""; ?>">
          <a href="<?php echo web_root; ?>admin/applicants/">
              ...
              <span class="label label-primary pull-right"><?php echo $pendingApplicants; ?></span>
          </a>
        </li>
        ...
        <li class="<?php echo (currentpage() == 'remarks') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>admin/remarks">
            <i class="fa fa-circle-o"></i> <span>Status</span>  
          </a>
        </li> 
       <!--  <li class="treeview">
          <a href="#">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2024 <a href="#">IMISS</a>.</strong> All rights
    reserved.
  </footer>
